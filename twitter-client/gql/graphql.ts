...
export type GetAllTweetsQuery = { __typename?: 'Query', getAllTweets?: Array<{ __typename?: 'Tweet', content: string, id: string, author?: { __typename?: 'User', email: string, firstName: string, lastName: string, profileImageURL?: string | null } | null } | null> | null };
